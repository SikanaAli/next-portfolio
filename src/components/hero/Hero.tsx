...
function Hero() {
	return (
		<>
			<div
				className="w-full h-screen text-center backdrop-blur-sm z-40 relative"
				id="hero"
			>
				<div className="max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center  ">
					<div className="backdrop-blur-[2px] z-50 bg-blend-overlay p-5 rounded-[50%]">
						...
						<div className="flex z-10 items-center justify-between max-w-[330px] m-auto py-4">
							<Link
								className="z-10 hover:mix-blend-normal border rounded-full shadow-lg hover:shadow-gray-400 p-6 cursor-pointer hover:scale-110 ease-in duration-300"
								href={
